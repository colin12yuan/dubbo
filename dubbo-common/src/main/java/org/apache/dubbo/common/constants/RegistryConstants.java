...
public interface RegistryConstants {
    ...
    String DEFAULT_REGISTER_MODE_INTERFACE = "interface"; // 接口级注册

    String DEFAULT_REGISTER_MODE_INSTANCE = "instance"; // 应用级注册

    String DEFAULT_REGISTER_MODE_ALL = "all"; // 接口级别和应用级都注册
    /**
